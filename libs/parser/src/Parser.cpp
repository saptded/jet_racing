    ...
    for (const auto &it_stages_tree : map_tree) {
        ...
        for (const auto &it_blocks_tree : stage_tree) {
            ...
            for (const auto &it_elements_tree : block_tree) {
                ...
                PointM start(element_tree.get<size_t>("<xmlattr>.startX"), element_tree.get<size_t>("<xmlattr>.startY"));
                PointM end(element_tree.get<size_t>("<xmlattr>.endX"), element_tree.get<size_t>("<xmlattr>.endY"));
                PointM center
