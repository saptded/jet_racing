...
std::vector<abstractElement> makeStage(){
    std::vector<abstractElement> stage{{{50, 550}, {50, 750}, {0, 0}, false, std::make_shared<DrawableLine>()},
                                       ...
                                       {{50, 550}, {350, 550}, {200, 550}, false, std::make_shared<DrawableArc>()},
                                       {{150, 550}, {200, 550}, {175, 550}, false, std::make_shared<DrawableArc>()},
                                       {{400, 750}, {200, 550}, {400, 550}, false, std::make_shared<DrawableArc>()},
                                       {{400, 600}, {350, 550}, {400, 550}, false, std::make_shared<DrawableArc>()},
                                       {{500, 500}, {400, 600}, {400, 500}, false, std::make_shared<DrawableArc>()},
                                       {{400, 750}, {500, 750}, {0, 0}, false, std::make_shared<DrawableLine>()},
                                       {{600, 650}, {500, 750}, {500, 650}, false, std::make_shared<DrawableArc>()},
                                       {{600, 650}, {600, 50}, {0, 0}, false, std::make_shared<DrawableLine>()},
                                       {{500, 500}, {500, 50}, {0, 0}, false, std::make_shared<DrawableLine>()},
                                       {{50,750}, {150,750},{0,0}, false, std::make_shared<DrawableLine>()},
                                       {{500,60}, {600,50},{0,0}, false, std::make_shared<DrawablePortal>()}
    };
    for (auto el : stage) {
        el.createDrawable(0);
    }
